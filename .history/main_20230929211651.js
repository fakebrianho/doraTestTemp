...
function updateLocatorPlus() {
	// Your logic to update locatorPlus based on the checkbox status
	// Check if the checkbox is checked or not
	const isChecked = checkbox.checked

	// Update your locatorPlus class or any other logic here based on the checkbox status
	// For example:
	if (checkbox25miles.checked) {
		locatorInstance.setRadius(25)
	} else if (checkbox50miles.checked) {
		locatorInstance.setRadius(50)
	}
}
